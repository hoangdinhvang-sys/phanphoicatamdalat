...
SiteStats.prototype.getLink = function () {
    ...
    if (document.referrer == null || document.referrer == "") {
        ...
        var link = '<div style="display:none"><img alt="alt" src="' + ServerLog + "Delivery/Logging?SiteId=" + this.siteId + "&Url=" + document.URL + '&ReferenceUrl=Null"/></div>';
    }
    else {
        var link = '<div style="display:none"><img alt="alt" src="' + ServerLog + "Delivery/Logging?SiteId=" + this.siteId + "&Url=" + document.URL + "&ReferenceUrl=" + document.referrer + '"/></div>';
    }
    return link;
}
...
function getTracking() {
    var siteStats = new SiteStats(114853); 
    siteStats.draw();
